...
public class CmlContextRefImpl extends ASTWrapperPsiElement implements CmlContextRef {

  public CmlContextRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CmlVisitor visitor) {
    visitor.visitContextRef(this);
  }

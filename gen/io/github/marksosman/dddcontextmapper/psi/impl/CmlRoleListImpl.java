...
public class CmlRoleListImpl extends ASTWrapperPsiElement implements CmlRoleList {

  public CmlRoleListImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CmlVisitor visitor) {
    visitor.visitRoleList(this);
  }
  ...
  @Override
  @NotNull
  public List<CmlRole> getRoleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CmlRole.class);
  }

...
public class CmlSubdomainImpl extends ASTWrapperPsiElement implements CmlSubdomain {

  public CmlSubdomainImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CmlVisitor visitor) {
    visitor.visitSubdomain(this);
  }

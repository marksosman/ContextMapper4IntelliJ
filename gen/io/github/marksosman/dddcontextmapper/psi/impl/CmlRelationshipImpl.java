...
public class CmlRelationshipImpl extends ASTWrapperPsiElement implements CmlRelationship {

  public CmlRelationshipImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<CmlRoleList> getRoleListList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, CmlRoleList.class);
  }
